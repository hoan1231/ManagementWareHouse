...
namespace CRM_Finance.Controllers
{
    ...
    public class AccountController : ApiController
    {
        ...
        // GET api/Account/UserInfoCustom
        ...
        public IHttpActionResult Logout()
        {
            ...
            Task.Factory.StartNew(() =>
            {
                _accountServices.CreateLoginHistory(new Models.EFModel.MNG_HistoryLogin()
                {
                    ...
                    UserName = Authentication.User.Identity.GetUserName(),
                    Status = "Logout"
                });
            });
        ...
        public async Task<bool> ValidateUser(RegisterBindingModel model)
        {
            ApplicationUser result = await UserManager.FindAsync(model.Email, model.Password);
            if (result == null)
                return false;
            return true;
        }
        ...
        private class ExternalLoginData
        {
            ...
            public IList<Claim> GetClaims()
            {
                ...
                if (UserName != null)
                {
                    ...
                    claims.Add(new Claim("Department", "Phòng ban"));
                }
